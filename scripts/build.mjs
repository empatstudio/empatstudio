...
const pages = [
  ...
  { source: 'misko-paslaptis.html', target: 'darbai/misko-paslaptis/index.html', route: '/darbai/misko-paslaptis/', label: 'Miško paslaptis', parent: workParent, shareImage: '/assets/projects/misko-paslaptis/share.jpg' },
